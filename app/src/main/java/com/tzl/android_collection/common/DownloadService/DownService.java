package com.tzl.android_collection.common.DownloadService;
                    ...
                    case 2:
                        ...
                        if (data.changer) {
                            ...
                            Toast.makeText(getApplicationContext(),
                                    data.filename + "下载取消", Toast.LENGTH_SHORT).show();
                        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(ConnectivityManager.CONNECTIVITY_ACTION)) {
                ...
                if (info != null && info.isAvailable()) {
                    ...
                    Toast.makeText(getApplicationContext(), "网络异常，下载服务停止！", Toast.LENGTH_SHORT)
                            .show();
                    onDestroy();
                }
            }
...
// 调用setSuspend(false)让当前线程恢复/唤醒
    ...
    private PendingIntent receiveMsmIntent(int flag, String url) {
        Intent intent = new Intent(getApplicationContext(), ManyTaskDownActivity.class);
        ...
        public void setSuspend(boolean suspend) {
            ...
            if (!suspend) {
                synchronized (control) {
                    ...
                    Toast.makeText(getApplicationContext(), filename+"继续下载---", Toast.LENGTH_SHORT).show();
